...
4.  Enter the storage container name in the format<br>*https://accountname.dfs.core.windows.net/containername/* and replace **accountname** and **containername** with you specific storage accounts infromation.
...
8. If prompted to sign in, you can sign in with your Azure Active Directory or with the **Account key**. To loging through **Account key**, select the option form the the left side bar.

9. Find the account key by going back to the storage account setting and selecting **Access keys** from the left pane. Copy the first key and paste it in Power BI. Select **OK**.
